...
//!!**!! Added CPV 05/09/2014
/**
 * @brief Set the PWM Control Register
 * @param	pTMR		: Pointer to timer IP register address
 * @param	pwmval		: PWM control value
 * @return	Nothing
 * @note	Sets the PWM Control Register.
 */
STATIC INLINE void Chip_TIMER_PWMControlSet(LPC_TIMER_T *pTMR, uint32_t pwmval)
{
	pTMR->PWMC = pwmval;
}
...
//!!**!! Added CPV 05/09/2014
/**
 * @brief Read the PWM Control Register
 * @param	pTMR	: Pointer to timer IP register address
 * @return	The contents of the PWM Control Register
 * @note	Returns the contents of the PWM Control Register.
 */
STATIC INLINE uint32_t Chip_TIMER_ReadPWMControl(LPC_TIMER_T *pTMR)
{
	return pTMR->PWMC;
}
